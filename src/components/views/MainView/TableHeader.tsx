...
export const TableHeader = memo<TableHeaderProps>(({columnWidths}) => {
  const headers = [
    ...
    {text: 'AGENT', width: columnWidths.ai, justify: 'center' as const},
    {text: 'Shell', width: columnWidths.shell, justify: 'center' as const},
    {text: 'eXec', width: columnWidths.run, justify: 'center' as const},
    ...
    {text: 'COMMITS', width: columnWidths.changes, justify: 'flex-end' as const},
